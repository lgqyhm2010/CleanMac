...
कैश, लॉग, डुप्लिकेट, बड़ी फ़ाइलें और अप्रयुक्त ऐप्स के लिए स्कैन करें — उन्हें एक स्थानीय AI CLI के साथ समीक्षा करें — और उन्हें सुरक्षित रूप से Trash में ले जाएँ। कोई अकाउंट नहीं, कोई टेलीमेट्री नहीं, कोई नेटवर्क नहीं।
...
जो इसे अलग बनाता है: यह विलोपन सूची को एक **स्थानीय AI CLI जो आपके पास पहले से स्थापित है** (Claude Code, Codex, या Gemini CLI) को सौंप सकता है ताकि यह पता चल सके कि क्या हटाना सुरक्षित है, इस पर एक दूसरी राय मिल सके। AI आपकी मशीन पर चलता है; कुछ भी अपलोड नहीं होता।
...
- 🗑️ **ऐप अनइंस्टॉलर** — एक ऐप *और* बंडल ID से जुड़ी उसकी बची हुई सहायक फ़ाइलों (Preferences, Caches, Application Support) को हटाता है।
...
- 🔒 **डिज़ाइन के अनुसार निजी** — कोई नेटवर्क कॉल नहीं, कोई टेलीमेट्री नहीं, कोई अकाउंट नहीं।

## AI समीक्षा (स्थानीय)

CleanMac आपके `PATH` पर समर्थित कमांड-लाइन AI टूल का पता लगाता है (सामान्य Homebrew, npm, asdf और volta स्थानों सहित) और आपको क्लीनअप उम्मीदवारों के एक बैच की समीक्षा करने के लिए एक चुनने देता है। ऐप एक संरचित JSON प्रॉम्प्ट बनाता है (पथ, आकार, संशोधित तिथि, श्रेणी, जोखिम, और लागू होने वाले सुरक्षा नियम), CLI को **आपकी होम डायरेक्टरी से** चलाता है, और उत्तर को वापस रंग-कोडित समूहों में पार्स करता है।
...
- **कोई नेटवर्क नहीं।** CleanMac कोई नेटवर्क कॉल नहीं करता। AI समीक्षा स्थानीय रूप से उन CLIs के माध्यम से होती है जिन्हें आपने स्वयं स्थापित किया है।
